        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="text-sm text-center">
            ...
            <div className="mt-2 text-stone-500">
              Site réalisé par <a href="https://www.linkedin.com/in/mikaelvery" target="_blank" rel="noopener noreferrer" className="text-emerald-500 hover:text-emerald-400 transition-colors">Mikael Very</a>
            </div>
          </div>
        </div>
      </div>
